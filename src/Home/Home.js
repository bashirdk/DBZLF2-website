...
const Home = () => (
  <div>  
    ...
    <div className="text-center mt-24">
      <iframe width="560" height="315" src="https://www.youtube.com/embed/qr8AJyuS-VY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
  </div>
);
